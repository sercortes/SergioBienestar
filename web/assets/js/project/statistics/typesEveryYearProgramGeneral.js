...
$(document).on('click', '#generateXlsOneGeneral', function () {

    exportCSVFile('cabecera', dataOne, titlee + 'participantes')
})

$(document).on('click', '#generateXlsTwoGeneral', function () {
...
function addDivs() {
    ...
    divOne.innerHTML = `<div id="graphicOne" style="height: 400px;"></div><hr>
                        <button id="generateXlsOneGeneral" type="button" class="btn btn-success mb-3 float-right noexportar">
    ...
    divTwo.innerHTML = `<div id="graphicTwo" style="height: 400px;"></div><hr>
                        <button id="generateXlsTwoGeneral" type="button" class="btn btn-success mb-3 float-right noexportar">
                        <i class="far fa-file-excel"></i> Generar</button>`
}
